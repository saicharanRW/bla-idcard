      ...
      <nav className="bg-sidebar border-b border-sidebar-border sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-8">
            <Link href="/admin/dashboard" className="text-xl font-bold text-sidebar-foreground">
              Event Control
            </Link>
            <div className="hidden md:flex gap-6">
              <Link href="/admin/dashboard" className="text-sidebar-accent-foreground hover:text-sidebar-foreground transition">
                Dashboard
              </Link>
              <Link href="/admin/guests" className="text-sidebar-accent-foreground hover:text-sidebar-foreground transition">
                Guests
              </Link>
            </div>
          </div>
